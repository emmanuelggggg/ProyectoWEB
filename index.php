    ...
    <!-- Barra buscadora -->
            ...
            <div class="anuncio">
                ...
                <div class="mensaje">
                    ...
                    <button type="button" onclick="location.href='/views/registerU_A.php'">Registrar</button>
                    <button type="button" onclick="location.href='/views/iniciarS.php'">Iniciar Sesion</button>
                </div>  
            </div>
        </div>
    </body>
